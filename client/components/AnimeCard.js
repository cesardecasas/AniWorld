...
const AnimeCard =(props)=>{
    ...
    return(
        <div id={id} className="card" style={{width: "75%", marginTop:'4%', marginLeft:'10%', boxShadow:'12px 12px 2px 1px rgba(0, 0, 255, .2)'}}>
            <img src={image} style={{width:'100%', maxHeight:'10%', height:'250px'}} className="card-img-top" alt="Anime poster"/>
